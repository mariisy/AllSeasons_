...
public class FarmingHarvestRecords extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_farming_harvest_records, container, false);
        ...
        arrayList = tDAO.retrieveTransactionList(dbHelper, "Storage");
        expandableListDetail = (HashMap<String, List<String>>) arrayList.get(3);
