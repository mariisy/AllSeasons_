...
public class WiFiServerBroadcastReceiver extends BroadcastReceiver {
    ...
    private SyncSettingsActivity activity;

    public WiFiServerBroadcastReceiver(WifiP2pManager manager, WifiP2pManager.Channel channel, SyncSettingsActivity activity) {
        super();
